      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-club-gray-400 text-sm mb-6">
              Club Atlético Central Goya - Fundado en 1923
            </p>
            
            {/* Redes Sociales */}
            <div>
              <h4 className="text-club-white font-semibold mb-4">Síguenos</h4>
              <div className="flex space-x-4">
                <a
                  href="https://www.facebook.com/centralgoya"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-club-gray-800 rounded-full flex items-center justify-center text-club-gray-400 hover:text-club-gold-500 hover:bg-club-gray-700 transition-all duration-300 hover:scale-110"
                  aria-label="Facebook"
                  title="Facebook"
                >
                ...
                <a
                  href="https://www.instagram.com/centralgoya"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-club-gray-800 rounded-full flex items-center justify-center text-club-gray-400 hover:text-club-gold-500 hover:bg-club-gray-700 transition-all duration-300 hover:scale-110"
                ...
                <a
                  href="https://www.twitter.com/centralgoya"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-club-gray-800 rounded-full flex items-center justify-center text-club-gray-400 hover:text-club-gold-500 hover:bg-club-gray-700 transition-all duration-300 hover:scale-110"
